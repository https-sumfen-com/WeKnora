        ...
        <template v-else-if="currentEngine === 'cos'">
          <div class="engine-info-block">
            <p class="engine-desc">
              ...
              <a v-if="!embedded" class="doc-link" href="https://console.cloud.tencent.com/cos" target="_blank" rel="noopener">{{ $t('settings.storage.console') }}<t-icon name="link" class="link-icon" /></a>
              <a v-if="!embedded" class="doc-link" href="https://cloud.tencent.com/document/product/436" target="_blank" rel="noopener">{{ $t('settings.storage.docs') }}<t-icon name="link" class="link-icon" /></a>
            </p>
          </div>
          <div class="engine-form">
            <div class="form-item">
        ...
        <template v-else-if="currentEngine === 'tos'">
          <div class="engine-info-block">
            <p class="engine-desc">
              ...
              <a v-if="!embedded" class="doc-link" href="https://console.volcengine.com/tos" target="_blank" rel="noopener">{{ $t('settings.storage.console') }}<t-icon name="link" class="link-icon" /></a>
              <a v-if="!embedded" class="doc-link" href="https://www.volcengine.com/docs/6349" target="_blank" rel="noopener">{{ $t('settings.storage.docs') }}<t-icon name="link" class="link-icon" /></a>
            </p>
          </div>
          <div class="engine-form">
            <div class="form-item">
        ...
        <template v-else-if="currentEngine === 's3'">
          <div class="engine-info-block">
            <p class="engine-desc">
              ...
              <a v-if="!embedded" class="doc-link" href="https://aws.amazon.com/s3/" target="_blank" rel="noopener">{{ $t('settings.storage.console') }}<t-icon name="link" class="link-icon" /></a>
              <a v-if="!embedded" class="doc-link" href="https://docs.aws.amazon.com/s3/" target="_blank" rel="noopener">{{ $t('settings.storage.docs') }}<t-icon name="link" class="link-icon" /></a>
            </p>
          </div>
          <div class="engine-form">
            <div class="form-item">
        ...
        <template v-else-if="currentEngine === 'oss'">
          <div class="engine-info-block">
            <p class="engine-desc">
              ...
              <a v-if="!embedded" class="doc-link" href="https://oss.console.aliyun.com/" target="_blank" rel="noopener">{{ $t('settings.storage.console') }}<t-icon name="link" class="link-icon" /></a>
              <a v-if="!embedded" class="doc-link" href="https://help.aliyun.com/zh/oss/" target="_blank" rel="noopener">{{ $t('settings.storage.docs') }}<t-icon name="link" class="link-icon" /></a>
            </p>
          </div>
          <div class="engine-form">
            <div class="form-item">
